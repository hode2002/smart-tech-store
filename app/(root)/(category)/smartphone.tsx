...
const Smartphone = () => {
    ...
    const operatingSystems: FilterFieldType[] = useMemo(
        () => [
            {
                id: 'all',
                label: 'Tất cả',
    ...
    const specialFeatures: FilterFieldType[] = useMemo(
        () => [
            {
                id: 'all',
                label: 'Tất cả',
    ...
    const charger: FilterFieldType[] = useMemo(
        () => [
            {
                id: 'all',
                label: 'Tất cả',
    ...
    const pin: FilterFieldType[] = useMemo(
        () => [
            {
                id: 'all',
                label: 'Tất cả',
