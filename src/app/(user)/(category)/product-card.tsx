...
export default function ProductCard(props: Props) {
    ...
    return (
        <div className="my-4">
            <ContextMenu>
                <ContextMenuTrigger>
                    <div className="bg-card w-[360px] hover:shadow-2xl hover:cursor-pointer hover:scale-[1.01] transition-all duration-300 border-[1px] border-[#ccc] rounded-md px-2 py-3 shadow-md m-3 flex flex-col justify-between">
                        {product?.label && (
                        ...
                        >
                            ...
                            <div className="flex gap-2 flex-wrap">
                                {product.product_options.map((p, idx) => {
                                    return (
                                        <Button
                                            key={idx}
                                            className=""
