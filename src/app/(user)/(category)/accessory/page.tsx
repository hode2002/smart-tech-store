...
export default function AccessoryPage() {
    ...
    const handleSelectedBrand = (slug: string) => {
        if (brands.some((e) => e.slug === slug)) {
            ...
            <div className="bg-popover">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Phụ kiện</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                <Sheet key={'left'}>
                                        ...
                                        >
                                            {brands && brands.length > 0 && (
                                                <>
                                                    ...
                                                    >
                                                        <p
                                                            className={`${selectedBrand === 'all' ? 'border-red-400' : ''} p-2 hover:border-red-400 border rounded-md flex justify-center items-center`}
                                                        >
                                                            Tất cả
                                                        </p>
                                                    </SwiperSlide>
                                                    {brands.map((item) => (
                                                        ...
                                                        >
                                                            <div
                                                                className={`${selectedBrand === item.slug ? 'border-red-400' : ''} hover:border-red-400 border rounded-md flex justify-center items-center`}
                                                            >
                                                                <Image
                                                                    src={
                                                                        item.logo_url
